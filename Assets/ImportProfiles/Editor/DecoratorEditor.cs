...
/// </summary>
public abstract class DecoratorEditor : AssetImporterEditor
{
	...
	protected void CallInspectorMethod(string methodName)
	{
		...
		{
			var flags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.FlattenHierarchy;
